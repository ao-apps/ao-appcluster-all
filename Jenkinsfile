...
def upstreamProjects = [
  ...
  'csync2', // <groupId>com.aoapps</groupId><artifactId>ao-appcluster-csync2</artifactId>
  'dnsonly', // <groupId>com.aoapps</groupId><artifactId>ao-appcluster-dnsonly</artifactId>
  'imap', // <groupId>com.aoapps</groupId><artifactId>ao-appcluster-imap</artifactId>
  'jdbc', // <groupId>com.aoapps</groupId><artifactId>ao-appcluster-jdbc</artifactId>
]
